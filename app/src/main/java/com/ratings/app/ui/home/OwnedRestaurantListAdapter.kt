...
class OwnedRestaurantListAdapter(private val clickHandler:(restaurant: MyRestaurantsQuery.GetOwnedrestaurant) -> Unit):
    ListAdapter<MyRestaurantsQuery.GetOwnedrestaurant, OwnedRestaurantViewHolder>(DIFF_CONFIG) {
    companion object {
